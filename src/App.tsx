...
const AppContent: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (repoUrl.trim()) {
      fetchRepo(repoUrl, githubToken || undefined);
    }
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-3">
              <input
                type="password"
                placeholder="GitHub Token (optional, lifts rate limits)"
                value={githubToken}
                onChange={(e) => setGithubToken(e.target.value)}
                className="px-4 py-2 bg-github-dark-bg-tertiary border border-github-dark-border rounded-lg text-sm text-github-dark-text placeholder-github-dark-text-secondary focus:outline-none focus:ring-2 focus:ring-github-dark-accent focus:border-transparent transition-all shadow-sm"
                title="Optional: Add token to increase rate limit from 60 to 5000 requests/hour"
              />
              <input
                type="password"
            ...
            <div className="w-full max-w-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center text-sm text-github-dark-text-secondary space-x-2">
                  ...
                  <p>Public repos • API key required for explanations</p>
                </div>
      ...
      <footer className="bg-github-dark-bg-secondary border-t border-github-dark-border py-3">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-xs text-github-dark-text-secondary">
            Powered by <span className="font-semibold text-github-dark-text">Gemini AI</span> • Built with ❤️
          </p>
        </div>
      </footer>
    </div>
